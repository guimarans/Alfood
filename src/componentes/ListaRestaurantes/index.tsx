...
const ListaRestaurantes = () => {
  ...
  return (<section className={style.ListaRestaurantes}>
    ...
    <form className={style.filtro} onSubmit={buscar}>
      <div className={style.filtro__pesquisa}>
        <input type="text" value={busca} onChange={evento => setBusca(evento.target.value)} placeholder="Buscar restaurantes" />
      </div>
      <div className={style.filtro__pesquisa}>
